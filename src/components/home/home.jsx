    ...
    <div className="bg-[#E8E9E8]  dark:bg-gray-800 dark:text-white  ">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-6 ">
              <div className="flex gap-12">
                <a
                  href="#contact"
                  className="relative inline-block px-6 py-3 max-sm:px-3 max-sm:py-3 bg-green-500 text-white rounded-lg shadow-md transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-green-500 to-green-800 opacity-0 transition-opacity duration-300 rounded-lg hover:opacity-100"></span>
      ...
      <section className="font-montserrat  dark:bg-gray-800 dark:text-white   ">
        ...
        <div className=" max-w-7xl font-montserrat rounded-lg mx-auto flex flex-col md:flex-row justify-center gap-8">
          {/* Skill 1 */}
          <div className="flex flex-col dark:text-white  dark:bg-gray-600 items-center bg-opacity-10 rounded-lg shadow-2xl p-8 text-center">
            <Image
              src={settings}
              alt="settings"
              width={120}
