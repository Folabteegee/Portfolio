...
const Footer = () => {
  return (
    <footer className="bg-gray-700 text-white py-10 max-sm:py-20 font-montserrat">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8">
          {/* About*/}
          <div>
            <h3 className="border-b-2 font-bold text-lg py-2">
          ...
          {/* Pages */}
          <div>
            <h3 className="text-lg border-b-2 py-2 font-bold">
